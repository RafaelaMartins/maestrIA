...
# CONFIGURAÇÃO GLOBAL
# ---------------------------
# os.environ["CUDA_VISIBLE_DEVICES"] = "-1"  # Force CPU (Removed in v3)
...
Settings.llm = Ollama(model="mistral:7b", request_timeout=1200.0, additional_kwargs={"num_gpu": 99})
Settings.embed_model = HuggingFaceEmbedding(model_name="sentence-transformers/all-MiniLM-L6-v2", device=device)
